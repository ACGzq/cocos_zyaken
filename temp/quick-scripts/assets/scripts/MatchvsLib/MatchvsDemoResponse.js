(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/MatchvsLib/MatchvsDemoResponse.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '2a806Ww62NMZoEHb8EOiDat', 'MatchvsDemoResponse', __filename);
// scripts/MatchvsLib/MatchvsDemoResponse.js
...
MatchvsDemoResponse.prototype.gameServerNotify = function (eventInfo) {
    //大概是这么写的
    var event = new cc.Event(action, true);
...
MatchvsDemoResponse.prototype.joinOpenNotify = function (notify) {
    console.log("房间打开通知");
    MatchvsDemoResponse.prototype.sendEventToUI(msg.MATCHVS_JOIN_OPEN_NOTIFY, { notify: notify, type: msg.MATCHVS_JOIN_OPEN_NOTIFY });
};
...
MatchvsDemoResponse.prototype.joinOpenResponse = function (rsp) {
    if (rsp.status === 200) {
        console.log("房间打开成功");
        MatchvsDemoResponse.prototype.sendEventToUI(msg.MATCHVS_JOIN_OPEN_RSP, { rsp: rsp, type: msg.MATCHVS_JOIN_OPEN_RSP });
    } else {
...
MatchvsDemoResponse.prototype.joinOverResponse = function (rsp) {
    if (rsp.status === 200) {
        console.log("房间关闭成功");
        MatchvsDemoResponse.prototype.sendEventToUI(msg.MATCHVS_JOIN_OVER_RSP, { rsp: rsp, type: msg.MATCHVS_JOIN_OVER_RSP });
    } else {
...
MatchvsDemoResponse.prototype.joinOverNotify = function (notify) {
    console.log("房间关闭通知");
    MatchvsDemoResponse.prototype.sendEventToUI(msg.MATCHVS_JOIN_OVER_NOTIFY, { notify: notify, type: msg.MATCHVS_JOIN_OVER_NOTIFY });
};
...
MatchvsDemoResponse.prototype.leaveRoomResponse = function (leaveRoomRsp) {
    if (leaveRoomRsp.status === 200) {
        ...
        MatchvsDemoResponse.prototype.sendEventToUI(msg.MATCHVS_LEAVE_ROOM, { leaveRoomRsp: leaveRoomRsp, type: msg.MATCHVS_LEAVE_ROOM });
    } else {
...
MatchvsDemoResponse.prototype.sendEventResponse = function (sendEventRsp) {
    if (sendEventRsp.status === 200) {
        MatchvsDemoResponse.prototype.sendEventToUI(msg.MATCHVS_SEND_EVENT_RSP, { sendEventRsp: sendEventRsp, type: msg.MATCHVS_SEND_EVENT_RSP });
    } else {
...
MatchvsDemoResponse.prototype.setFrameSyncResponse = function (rsp) {
    MatchvsDemoResponse.prototype.sendEventToUI(msg.MATCHVS_SET_FRAME_SYNC_RSP, { rsp: rsp, type: msg.MATCHVS_SET_FRAME_SYNC_RSP });
    if (rsp.status === 200) {
        console.log('帧率设置成功');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=MatchvsDemoResponse.js.map
