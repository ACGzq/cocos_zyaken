(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/interface/Match.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '484a99DADxHZr2WX8hCpe4u', 'Match', __filename);
// scripts/interface/Match.js
...
cc.Class({
     ...
     * @param userInfoList
     */
    joinRoom: function joinRoom(userInfoList) {
     ...
     * @param userList
     */
    initUserView: function initUserView(userList) {
    ...
    kickPlayerName: function kickPlayerName(userID) {
        for (var i in this.userList) {
            ...
            if (obj.userID === userID) {
                for (var _i = 0; _i < this.nameViewList.length; _i++) {
                    if (this.userList[_i].name === this.nameViewList[_i][0].string) {
                        this.nameViewList[_i][0].string = "";
                        return;
                    }
                }
            }
